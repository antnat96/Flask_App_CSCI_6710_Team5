...
@application.route("/ourTeam")
def ourTeam():
    return render_template("ourTeam.html")

@application.route("/ourMotivation")
def ourMotivation():
    return render_template("ourMotivation.html")

@application.route("/deleteFlight")
def deleteFlight():
...
@application.route("/addFlightLogic")
def addFlightLogic():
    # Insert the document
...
@application.route("/searchAircraftInfo")
...
@application.route("/searchFlightInfo")
...
@application.route("/searchCargoInfo")
def searchCargoInfo():
